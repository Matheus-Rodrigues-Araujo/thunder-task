...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: <FaPeopleGroup size="10rem" color="white" />,
  ...
  },
  {
    ...
    icon: <SiMlflow size="10rem" color="white" />,
  ...
  },
  {
    ...
    icon: <FaClockRotateLeft size="10rem" color="white" />,
    subtitle: 'Controle e gerecie seu Tempo',
    description: 'Fornecer funcionalidades para rastrear o tempo gasto em tarefas e projetos. Permitir a definição de prazos, a criação de cronogramas e o monitoramento do tempo real para aumentar a produtividade.',
  },
];
